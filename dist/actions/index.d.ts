...
export declare class InitNamada {
    ...
    getAccounts: () => Promise<import("namada-connect/src/customGlobal").DerivedAccount[] | undefined>;
    getSigner: () => Promise<any>;
    getChainId: () => Promise<string | undefined>;
    getDefaultAccount: () => Promise<import("namada-connect/src/customGlobal").DerivedAccount | undefined>;
    login: () => Promise<import("namada-connect/src/customGlobal").DerivedAccount[] | undefined>;
}
